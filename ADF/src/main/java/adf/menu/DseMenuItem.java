 ...
 */
public class DseMenuItem extends AbstractButton implements  MenuElement  {
    ...
    /**
     * Creates a <code>DseMenuItem</code> with the specified icon.
     *
     * @param icon the icon of the <code>DseMenuItem</code>
     */
    public DseMenuItem(Icon icon) {
        this(null, icon);
    }

    /**
     * Creates a <code>DseMenuItem</code> with the specified text.
     *
     * @param text the text of the <code>DseMenuItem</code>
     */
    public DseMenuItem(String text) {
        this(text, (Icon)null);
    }
     ...
     *
     * @param a the action of the <code>DseMenuItem</code>
     * @since 1.3
     */
    public DseMenuItem(Action a) {
        this();
        setAction(a);
    }

    /**
     * Creates a <code>DseMenuItem</code> with the specified text and icon.
     *
     * @param text the text of the <code>DseMenuItem</code>
     * @param icon the icon of the <code>DseMenuItem</code>
     */
    public DseMenuItem(String text, Icon icon) {
    ...
    /**
     * Creates a <code>DseMenuItem</code> with the specified text and
     * keyboard mnemonic.
     *
     * @param text the text of the <code>DseMenuItem</code>
     * @param mnemonic the keyboard mnemonic for the <code>DseMenuItem</code>
     */
    public DseMenuItem(String text, int mnemonic) {
        setModel(new DefaultButtonModel());
        init(text, null);
...
//    }
    ...
    /**
     * Inititalizes the focusability of the the <code>DseMenuItem</code>.
     * <code>DseMenuItem</code>'s are focusable, but subclasses may
...
//        setUIProperty("borderPainted", Boolean.FALSE);
    ...
    private static class MenuItemFocusListener implements FocusListener,
        ...
        public void focusLost(FocusEvent event) {
            ...
            DseMenuItem mi = (DseMenuItem)event.getSource();
     ...
     *                  DseMenuItem's actionlisteners without navigating the
     *                  menu hierarchy
     *           bound: true
     *       preferred: true
     */
    ...
    public void processKeyEvent(KeyEvent e,MenuElement path[],MenuSelectionManager manager) {
        if (DEBUG) {
            System.out.println("in DseMenuItem.processKeyEvent/3 for " + getText() +
    ...
    public void processMenuKeyEvent(MenuKeyEvent e) {
        if (DEBUG) {
            System.out.println("in DseMenuItem.processMenuKeyEvent for " + getText()+
                    "  " + KeyStroke.getKeyStrokeForEvent(e));
        }
        switch (e.getID()) {
    ...
    protected void fireMenuKeyPressed(MenuKeyEvent event) {
        if (DEBUG) {
            System.out.println("in DseMenuItem.fireMenuKeyPressed for " + getText()+
    ...
    protected void fireMenuKeyReleased(MenuKeyEvent event) {
        if (DEBUG) {
            System.out.println("in DseMenuItem.fireMenuKeyReleased for " + getText()+
                    "  " + KeyStroke.getKeyStrokeForEvent(event));
        }
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
    ...
    protected void fireMenuKeyTyped(MenuKeyEvent event) {
        if (DEBUG) {
            System.out.println("in DseMenuItem.fireMenuKeyTyped for " + getText()+
                    "  " + KeyStroke.getKeyStrokeForEvent(event));
        }
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
     ...
     * to this DseMenuItem with addMenuDragMouseListener().
     *
     ...
     * to this DseMenuItem with addMenuKeyListener().
     *
    ...
    /**
     * Returns a string representation of this <code>DseMenuItem</code>.
     * This method is intended to be used only for debugging purposes,
     * and the content and format of the returned string may vary between
     * implementations. The returned string may be empty but may not
     * be <code>null</code>.
     *
     * @return  a string representation of this <code>DseMenuItem</code>
     */
...
////////////////
     ...
     * <code>DseMenuItem</code>. For <code>DseMenuItem</code>s,
     ...
     *         <code>AccessibleContext</code> of this <code>DseMenuItem</code>
     */
     ...
     * <code>DseMenuItem</code> class.  It provides an implementation of the
    ...
    protected class AccessibleJMenuItem extends AccessibleAbstractButton implements ChangeListener {
        ...
        AccessibleJMenuItem() {
            super();
            DseMenuItem.this.addChangeListener(this);
        }
        ...
        private void fireAccessibilityFocusedEvent(DseMenuItem toCheck) {
            MenuElement [] path =
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            if (DseMenuItem.this.getModel().isArmed()) {
                if (!isArmed) {
                    isArmed = true;
                    firePropertyChange(
                            AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
                    ...
                    // Here we will fire the event in case of DseMenuItem
                    // See bug 4910323 for details [zav]
                    fireAccessibilityFocusedEvent(DseMenuItem.this);
                }
            } else {
                if (isArmed) {
                    isArmed = false;
            ...
            if (DseMenuItem.this.isFocusOwner()) {
                if (!hasFocus) {
                    hasFocus = true;
                    firePropertyChange(
                            AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
            ...
            if (DseMenuItem.this.getModel().isPressed()) {
                if (!isPressed) {
                    isPressed = true;
                    firePropertyChange(
                            AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
            ...
            if (DseMenuItem.this.getModel().isSelected()) {
                if (!isSelected) {
                    isSelected = true;
                    firePropertyChange(
                            AccessibleContext.ACCESSIBLE_STATE_PROPERTY,

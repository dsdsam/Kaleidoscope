...
public abstract class BasicAsynchronousAction extends AbstractAction implements ServiceExecutionListener {
     ...
     * @param name
     */
    public BasicAsynchronousAction(String name) {
        this(null, name);
    }

    public BasicAsynchronousAction(JFrame frame, String name) {
        super(name);
        this.frame = frame;
    }

    public BasicAsynchronousAction() {
...
//            }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        BasicAsynchronousAction listener = null;
        if (event != null) {

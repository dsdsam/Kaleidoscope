 ...
 *
 */
class SEMetalBumps implements Icon {
    ...
    public SEMetalBumps( Dimension bumpArea ) {
        this( bumpArea.width, bumpArea.height );
    }

    public SEMetalBumps( int width, int height ) {
...
//    setBumpColors( Color.PINK, Color.cyan, Color.YELLOW );
    }

...
public class MclnStateVector extends AbstractVector {

    private static final Color HIGHLIGHTED_BACKGROUND_COLOR = new Color(0x94D352);

    public MclnStateVector(boolean horizontal, VectorDataModel vectorDataModel, int nElements, int width, int height) {

...
//            append("<div style=\"font-size:19px; font-weight: plain; color:#780000; text-align:center; ").
            append("<div style=\"font-size:16px; font-weight: plain; color:#AA0000; text-align:center; ").
            append(" \">").
...
//            append("<div style=\"font-size:14px; font-weight: plain; color:#780000; text-align:justify; ").
            append("<div style=\" font-size:14px; font-weight: plain;    color:#550000; text-align:justify;   ").
...
//            append("<div style=\"font-size:10px; font-weight: plain; color:#787878; text-align:justify; ").
            append("<div style=\"font-size:12px; font-weight: plain; color:#000050; text-align:justify; ").
            append(" \">").

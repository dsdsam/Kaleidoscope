...
public class DsdsseWorldScalableCSysGrid extends CSysRectangleEntity {
     ...
     * @param gridColor
     */
    public DsdsseWorldScalableCSysGrid(CSysView parentCSysView, double gridCSysStep, int gridMargin, Color gridColor) {
    ...
    private final List<int[]> gridLineScrXCoordinates = new ArrayList();
    private final List<int[]> gridLineScrYCoordinates = new ArrayList();
     ...
     */
    public void snapMouseToTheGrid(MouseEvent me) {

 ...
 */
public class CSysRectangleEntity extends BasicCSysEntity {
     ...
     */
    public CSysRectangleEntity(CSysView parentCSysView, DoubleRectangle doubleRectangle) {
     ...
     * @param y2
     */
    public CSysRectangleEntity(CSysView parentCSysView, double x1, double y1, double x2, double y2) {

...
import adf.ui.laf.ColorFilter;
import adf.ui.laf.StyleSupport;
 ...
 */
public class AdfButton3DUI extends MetalButtonUI
{
    ...
    static public ComponentUI createUI(JComponent c) {
        return new AdfButton3DUI();
    }

//    protected BasicButtonListener createButtonListener(AbstractButton b) {
//        boolean bIsVetoable = (b instanceof IMouseVetoableComponent);
//        // create a vetoable listener if the button itself supports that functionality
//        if (bIsVetoable) {
//            return new VetoableButtonListener(b);
//        }
//        // don't create the vetoable listener if the button does not need that
//        else {
...
//    }
    ...
    public void installUI(JComponent arg_oComp) {
        ...
        //System.out.println("------->> OrionButtonUI.installUI():  comp = " + arg_oComp.getClass().getName() + ", method = " + sMeth);
    }

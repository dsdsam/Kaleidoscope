...
public class JCheckBox2 extends JCheckBox {
    ...
    public JCheckBox2(final Action a) {
        super(a);
    }

    public JCheckBox2(final Icon icon, final boolean selected) {
        super(icon, selected);
    }

    public JCheckBox2(final Icon icon) {
        super(icon);
    }

    public JCheckBox2(final String text, final boolean selected) {
        super(text, selected);
    }

    public JCheckBox2(final String text, final Icon icon, final boolean selected) {
        super(text, icon, selected);
    }

    public JCheckBox2(final String text, final Icon icon) {
        super(text, icon);
    }

    public JCheckBox2(final String text) {
        super(text);
    }

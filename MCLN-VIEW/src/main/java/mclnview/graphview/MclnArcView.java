...
public class MclnArcView extends MclnGraphEntityView<MclnArc> implements Cloneable {
     ...
     * @param inpNode
     */
    MclnArcView(MclnGraphView parentCSys, MclnArc mclnArc, MclnGraphViewNode inpNode) {
...
//        this.threshold = threshold;
    ...
    public void finishArcCreation() {
        ...
        java.util.List<double[]> knotCSysLocations = this.getKnotCSysLocations();
...
//        this.UID = mclnArc.getUID();
        ...
        java.util.List<double[]> knotCSysLocations = mclnArc.getKnotCSysLocations();
...
//    }
    ...
    public void takeFinalLocation(double[] translationVector) {
        mclnGraphSplineViewEntity.takeFinalLocation(translationVector);
        java.util.List<double[]> knotCSysLocations = mclnGraphSplineViewEntity.getSplineCSysKnots();
        mclnArc.setCSysKnots(knotCSysLocations);
    }
...
//    }
    ...
    public final java.util.List<double[]> getKnotCSysLocations() {
